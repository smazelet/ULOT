...
- `functional_minimization.py`: code for minimizing a graph with respect the FUGW loss (Figure 5).
...
- `effect_rho_alpha.py`: code to compute the ULOT transport plan between a pair of SBMs for increasing values of tradeoff parameters (Figures 2 and 3)
